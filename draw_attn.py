...
def parser():
       ...
       parser.add_argument("-source_dir",type=str, default="D:\leetcode\draw\draw_attn\source_sentence")
       parser.add_argument("-target_dir",type=str, default="D:\leetcode\draw\draw_attn\\target_sentence")
